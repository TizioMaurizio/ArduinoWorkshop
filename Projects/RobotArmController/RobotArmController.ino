...
//Motor variables
int targetPoses[16] = {90, 180, 150, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90};
...
int increment = 4; //change this to speed up movement once interval is at minimum
