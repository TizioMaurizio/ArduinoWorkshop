        ...
        try:
            while cond_while:
                ...
                if color_stat_available < threshold_low and color_conv_entering > threshold_high:
                    ...
                    motor_block.run_to_abs_pos(position_sp=pos_push,
                                               speed_sp=pusher_speed)  # Now, we close the block, in order to avoid the entering of too many pieces into the station
                    ...
                    if not Timeout:
                        ...
                        if w_distribution_type == 'triangular' or w_distribution_type == 'Triangular':
                            Tw_Astoc = random.triangular(w_distribution_par[0], w_distribution_par[1],
                                                         w_distribution_par[2])  # random.triangular(low, high, mode)
                        ...
                        if random.random() <= (1 - failure_prob):  # WORKING STATE
                            ...
                            if f_distribution_type == 'triangular' or f_distribution_type == 'Triangular':
                                Tf_Astoc = random.triangular(f_distribution_par[0], f_distribution_par[1],
                                                             f_distribution_par[
...
#except userInterrupt as g:
    #ValidCycle = False


# fuori dal config: hold,