...
while(True):
    with mss.mss() as sct:
        ...
        monitor = {"top": 100, "left": 300, "width": 640, "height": 480}
    ...
    hsv_frame = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
     ...
     # Red color
    imagered = np.zeros((480, 640, 3), np.uint8)
    imagered[:] = (0, 0, 255)
    ...
    # Blue color
    imageblue = np.zeros((480, 640, 3), np.uint8)
    imageblue[:] = (255, 0, 0)
    ...
    # Green color
    imagegreen = np.zeros((480, 640, 3), np.uint8)
    imagegreen[:] = (0, 255, 0)
    ...
    # Yellow color
    imageyellow = np.zeros((480, 640, 3), np.uint8)
    ...
    # Cyan color
    imagecyan = np.zeros((480, 640, 3), np.uint8)
    imagecyan[:] = (255, 255, 0)
    ...
    # Pink color
    imagepink = np.zeros((480, 640, 3), np.uint8)
    imagepink[:] = (255, 0, 255)
    ...
    # White color
    imagewhite = np.zeros((480, 640, 3), np.uint8)
